			...
			<div class="mt-5">
				<aui:form action="${saveEmployeeActionURL}" method="POST">
					...
					<aui:input name="employeeId" type="hidden"
						value="${employee != null ? employee.employeeId : 0}" />
					...
					<aui:row cssClass="mb-3">
						<aui:col width="50">
							<aui:input label="First Name"
								...
								value="${employee != null ? employee.firstName : ''}">
						...
						<aui:col width="50">
							<aui:input label="Last Name"
								...
								value="${employee != null ? employee.lastName : ''}" />
						</aui:col>
					</aui:row>
					...
					<aui:row cssClass="mb-3">
						<aui:col width="100">
							<aui:input label="Designation"
								...
								value="${employee != null ? employee.designation : ''}" />
						</aui:col>
					</aui:row>
					...
					<aui:row cssClass="mb-3">
						<aui:col width="50">
							<aui:input label="Email"
								...
								value="${employee != null ? employee.emailAddress : ''}">
								<aui:validator name="required" />
							</aui:input>
						</aui:col>
						<aui:col width="50">
							<aui:input label="Phone"
								...
								value="${employee != null ? employee.phoneNumber : ''}" />
						</aui:col>
					</aui:row>
					...
					<aui:row cssClass="mb-3">
						<aui:col width="50">
							<aui:input label="Address Line 1"
								...
								value="${employee != null ? employee.addressLine1 : ''}" />
						</aui:col>
						<aui:col width="50">
							<aui:input label="Address Line 2"
								...
								value="${employee != null ? employee.addressLine2 : ''}" />
						</aui:col>
					</aui:row>
					...
					<aui:row cssClass="mb-4">
						<aui:col width="50">
							<aui:input label="City"
								...
								value="${employee != null ? employee.city : ''}" />
						</aui:col>
						<aui:col width="50">
							<aui:input label="Postal Code/Zip Code"
								...
								value="${employee != null ? employee.zipCode : ''}" />
						</aui:col>
					</aui:row>
